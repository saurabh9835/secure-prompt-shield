...
/**
 * Fastify adapter — PLANNED FOR PHASE 3, NOT YET IMPLEMENTED.
 *
 ...
 * rather than silently returning a no-op plugin that would give a false
 * sense of protection.
 *
...
function fastifyAdapter() {
  throw new Error(
    "secure-prompt-shield: the Fastify adapter is not implemented yet (planned for Phase 3). " +
